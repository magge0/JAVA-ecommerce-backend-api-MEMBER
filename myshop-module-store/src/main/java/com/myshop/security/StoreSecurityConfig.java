...
public class StoreSecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, AuthenticationConfiguration authenticationConfiguration) throws Exception {
        ...
        http.addFilterBefore(new StoreAuthenticationFilter(authenticationManager, storeTokenProvider, storeRoleMenuService, employeeService, cache), UsernamePasswordAuthenticationFilter.class);
