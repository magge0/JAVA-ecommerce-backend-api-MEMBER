...
@Configuration
public class SecurityConfigForManagement {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, AuthenticationConfiguration authenticationConfiguration) throws Exception {
        ...
        http.addFilterBefore(new AuthenticationFilterForManagement(authenticationManager, menuService, managerTokenProvider, cache), UsernamePasswordAuthenticationFilter.class);
