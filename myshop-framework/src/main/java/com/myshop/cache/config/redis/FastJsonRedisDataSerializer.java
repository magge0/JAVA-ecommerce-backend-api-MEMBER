package com.myshop.cache.config.redis;
...
/**
 * Để thực hiện cache đối tượng, bạn cần định nghĩa bộ serializer và deserializer riêng của mình.
 * Thường thì sử dụng thư viện fastjson của Alibaba để thực hiện.
 *
 * @author vantrang
 */
